             ...
             <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
               ...
               <div className="mt-6">
                 ...
                 <button
                   ...
                   className="mt-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded"
                 >
                   {isFollowing ? "Unfollow" : "Follow"} Designer
                 </button>
               </div>
             </div>
           </div>
